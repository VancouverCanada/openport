          ...
          {section === 'workspace' ? (
            <section className="chat-settings-section">
              <div className="chat-settings-copy">
                ...
                <span>Open the same core modules that upstream UI surfaces from Workspace.</span>
              </div>
          ...
          {section === 'about' ? (
            <section className="chat-settings-section">
              <div className="chat-settings-copy">
                ...
                <span>Chat-first self-hosted UI aligned with the upstream UI application structure.</span>
              </div>
